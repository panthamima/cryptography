...
#define unsigned char u1byte
#define unsigned short int u2byte; 
#define unsigned long int  u4byte; 
#define signed char     s1byte;
#define signed short int   s2byte;
#define signed long int    s4byte;
