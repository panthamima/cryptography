...
int main(int argc, char *argv[]) {
    char *in = "aasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdasasdsdasdasdasdasdas";
    char buffer[64];
    int len = 64;
    sha256(in, buffer, len);
    printf("buffer is:  %s\n", buffer);
}